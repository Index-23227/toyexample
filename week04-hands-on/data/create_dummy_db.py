"""
4주차 어드밴스 실습용 — SQLite 더미 DB 생성
실행: python create_dummy_db.py
...
cur.executemany("INSERT OR REPLACE INTO corporations VALUES (?,?,?,?)", corps)
...
cur.executemany("INSERT OR REPLACE INTO exchange_rates VALUES (?,?,?)", rates)
